...
from littleweb.registration.views import activate
from littleweb.registration.views import register
...
urlpatterns = patterns('',
                       ...
                       url(r'^custom-success/$',
                           direct_to_template,
                           {'template': 'test_template_name.html'},
                           name='registration_test_custom_success_url'),
                       (r'', include('littleweb.registration.backends.default.urls')),
                       )
